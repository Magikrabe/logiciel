...
def display_python_info():
    python_info = """
Python est un langage de programmation puissant, polyvalent et facile à apprendre. Il est largement utilisé dans le développement web, l'intelligence artificielle, l'analyse de données, l'automatisation, et bien plus encore. Grâce à sa syntaxe claire et élégante, Python permet d'écrire du code lisible et maintenable.

L'interpréteur Python et sa vaste bibliothèque standard sont disponibles gratuitement pour toutes les principales plateformes. Vous pouvez télécharger Python à partir du site officiel : https://www.python.org/downloads/

Python est idéal pour les débutants en programmation grâce à sa simplicité et à sa facilité d'utilisation. Cependant, il est également utilisé par de nombreuses grandes entreprises et organisations pour développer des applications et des projets complexes.

Python prend en charge la programmation orientée objet, fonctionnelle et impérative. Il dispose de nombreuses bibliothèques tierces qui facilitent le développement de divers types d'applications.

Enfin, Python est largement utilisé dans le domaine de l'apprentissage automatique et de l'intelligence artificielle, avec des bibliothèques populaires telles que TensorFlow, PyTorch et Scikit-learn.
    """
...
# Créer le bouton "Code à compléter (Python)"
...
# Créer le bouton "Code à compléter (Ruby)"
